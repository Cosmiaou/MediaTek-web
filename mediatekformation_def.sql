...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 28 nov. 2025 à 15:57
...
('DoctrineMigrations\\Version20251122140800', '2025-11-22 14:08:09', 99);
...
(2, 1, '2021-01-02 00:00:00', 'Eclipse n°7 : Tests unitaire', 'Intégration de JUnit dans l\'application et création de tests unitaires.00:07 : rappel sur le principe du test unitaire01:01 : intégrer JUnit au projet (une seule fois)01:52 : créer une classe de test03:49 : créer une méthode de test08:35 : lancer le test09:11 : créer une autre méthode de test pour tester la même méthode11:02 : relancer le test', '-nw42Xq6cYE'),
...
(1, 'admin', '[\"ROLE_ADMIN\"]', '$2y$13$TG2ERit4JCkgMxQd65XYpukFIh/.pJRbwGlWu/wmAQej3QLhA9Jou');
